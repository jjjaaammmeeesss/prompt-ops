#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Compare general-dialogue-popup v1.4 vs merged v2.2."""
import json
import os
import re
...
def main():
    ...
    with open(os.path.join(base_dir, "..", "general-dialogue-popup", "system_prompt_v1.4.txt"), "r", encoding="utf-8") as f:
        v14 = f.read()
    ...
    for sample_id in ["manager_anger", "couple_chase_dodge", "friend_soft_boundary"]:
        ...
        for name, prompt in [("v1.4", v14), ("v2.2", v22)]:
            print("-" * 70)
            print(f"[{name}]:")
